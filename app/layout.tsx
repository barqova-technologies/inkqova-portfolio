...
export const metadata: Metadata = {
  ...
  category: "Custom Printing & Corporate Gifting",
  robots: {
    index: true,
    follow: true,
    googleBot: {
...
/** Organization + WebSite + Service structured data for search engines. */
const jsonLd = {
  ...
  "@graph": [
    {
      ...
      sameAs: [SITE.instagramHref, SITE.craftedBy.href],
    },
    {
      "@type": "WebSite",
    ...
    {
      "@type": "Service",
      name: "Custom Printing & Corporate Gifting",
      provider: { "@id": `${SITE.canonical}/#organization` },
      areaServed: "IN",
      serviceType: [
        "Custom T-Shirt Printing",
        "Corporate Gifting",
        "Coffee Mug Printing",
        "Custom Diary & Notebook Printing",
        "Promotional Pens",
        "Branded Merchandise",
      ],
    },
